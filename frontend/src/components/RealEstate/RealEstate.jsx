...
const AnnouncementsTitle = ({
  ...
  <div
    className={`w-full flex flex-col md:flex-row justify-between gap-6 px-2 md:px-0 -mb-3 md:mb-8 ${className}`}
  >
    {/* Title and arrow */}
    ...
    <section className="bg-white py-10 md:py-20 px-5 font-montserrat relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative">
        <motion.div
          ...
          className="flex flex-col lg:flex-row lg:justify-between lg:items-start gap-6 md:gap-10 mb-8 md:mb-16"
        >
          <div className="flex-shrink-0">
            <motion.h2
              ...
              className="text-[26px] md:text-4xl lg:text-5xl font-extrabold mb-1 md:mb-4 bg-gradient-to-r from-indigo-900 to-purple-700 bg-clip-text text-transparent"
            >
              {sectionData.title}
            </motion.h2>
            <motion.div
        ...
        {hasMoreProjects && (
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="bg-gradient-to-r from-indigo-900 to-purple-800 hover:from-indigo-800 hover:to-purple-700 text-white font-semibold py-2 md:py-4 px-6 md:px-10 rounded-full transition-all duration-300 shadow-lg hover:shadow-xl relative overflow-hidden group"
            >
  ...
  return (
    <div className="font-montserrat bg-white m-0 p-0 pt-16 md:pt-20">
      ...
      >
        ...
        <h1 className="relative z-10 text-white text-xl md:text-4xl lg:text-5xl font-bold tracking-wide bg-black/70 px-4 md:px-6 py-2 md:py-3 rounded-lg shadow-lg text-center">
      ...
      >
        ...
        {/* Card Grid */}
        <div className="flex flex-wrap gap-6 md:gap-8 justify-evenly max-w-7xl mx-auto my-8 md:my-16 px-2">
          {Object.entries(staticData.cards).map(([key, card]) => (
            <div
              key={key}
              className="bg-white rounded-lg shadow-lg hover:shadow-xl p-4 md:p-6  sm:w-72 text-center transition-shadow duration-300 cursor-pointer group"
            >
