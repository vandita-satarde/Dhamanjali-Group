            ...
            <div className="mb-6">
              <div className="flex flex-col sm:flex-row items-stretch rounded-lg overflow-hidden shadow-md">
                ...
                <button
                  ...
                  disabled={loading}
                  className="bg-amber-600 text-white px-6 py-3 hover:bg-amber-700 transition-colors duration-200 font-semibold disabled:opacity-50 disabled:cursor-not-allowed"
                >
